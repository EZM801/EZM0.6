...
import { ArrowLeft, Edit, Package, PackageCheck, Truck, Home, Image as ImageIcon, QrCode, Box } from "lucide-react"
      ...
      <div className="container py-10">
        <div className="mb-8">
          <Button variant="ghost" asChild className="mb-4 rounded-full">
            <Link href={`/dashboard/company/moves/${moveId}/item-lists/${itemListId}`}>
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <Button variant="outline" asChild className="rounded-full">
            <Link href={`/dashboard/company/moves/${moveId}/item-lists/${itemListId}/items/${itemId}/edit`}>
              ...
              {item?.photos?.[0] ? (
                <div className="relative h-32 w-32 rounded-lg overflow-hidden">
                  <Image
                    ...
                    alt={item.photos[0].description || item.name}
                    fill
