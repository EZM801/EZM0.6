...
export default function CreateTaskPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      const redirectUrl = itemListId 
        ? `/dashboard/move/${moveId}/item-lists/${itemListId}`
        : `/dashboard/move/${moveId}?tab=tasks`
  ...
  return (
    <div className="container py-10">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold tracking-tight gradient-text">Create New Task</h1>
        <p className="text-muted-foreground">Add a new task to your move</p>
      </div>
